    ...
    return (
      ...
      <div className="aboutContainer">
        <div className='aboutL'>
          ...
          <ul>
            <li>Perfect for solo or couples travellers — we have tried three, it’s a bit of a squeeze.</li>
              <li>Micro-kitchen featuring a hot plate, kettle, stove, microwave and storage cupboards.</li>
              <li>Standard connection rod, suitable for hitching to any medium to large sized vehicle.</li>
          </ul>
        </div>
